...
resource "google_secret_manager_secret" "google_refresh_token" {
...
resource "google_secret_manager_secret_version" "google_refresh_token" {
  secret      = google_secret_manager_secret.google_refresh_token.id
